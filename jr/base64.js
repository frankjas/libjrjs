...
var _Base64 = {
	...
	encode : function (input) {
		...
		while (i < input.length) {
			...
			output = output +
			_Base64._keyStr.charAt(enc1) + _Base64._keyStr.charAt(enc2) +
			_Base64._keyStr.charAt(enc3) + _Base64._keyStr.charAt(enc4);
...
function jr_Base64Encode( string)
{
	return _Base64.encode( string);
}

function jr_Base64Decode( string)
{
